...
A lean, full-stack agentic protocol. ~2,500 LOC TypeScript. **v5.19.0**
...
| `skills` | `string \| string[]` | auto-discover | No | Skill directories. Default: checks `./skills`, `./.skills` |
...
| `temperature` | `number` | env `TEMPERATURE` / `0.0` | No | Sampling temperature. Auto-overridden for fixed-temp models (GPT-5 → 1.0) |
